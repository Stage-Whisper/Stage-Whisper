 ...
 */
export const deleteEntry = async (entryUUID: string): Promise<void> => {
 ...
 */
export const fetchAudioFile = async (audioPath: string): Promise<{audioFile: Uint8Array}> => {
 ...
 */
export const removeEntry = async (entry: Entry): Promise<{entry: Entry}> => {
 ...
 */
export const removeLine = async (lineUUID: string): Promise<{line: Line}> => {
 ...
 */
export const updateEntry = async (entry: Entry): Promise<{entry: Entry}> => {
 ...
 */
export const updateLine = async (line: Line): Promise<{line: Line}> => {
 ...
 */
export const getEntry = async (entryUUID: string): Promise<{entry: Entry}> => {
 ...
 */
export const getLine = async (lineUUID: string): Promise<{line: Line}> => {
 ...
 */
export const getLineCount = async (transcriptionUUID: string): Promise<{lineCount: number}> => {
 ...
 */
export const getLatestLines = async (transcriptionUUID: string): Promise<{lines: Line[]}> => {
  return new Promise((resolve, reject) => {
    ipcRenderer
