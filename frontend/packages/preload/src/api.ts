...
export const api = {
  ...
  ADD_TRANSCRIPTION: async (
    ...
    return (await ipcRenderer.invoke(
      ...
      args,
    )) as QueryReturn[QUERY.ADD_TRANSCRIPTION];
  },
  ...
  REMOVE_TRANSCRIPTION: async (
    ...
    return (await ipcRenderer.invoke(
      QUERY.REMOVE_TRANSCRIPTION,
      args,
    )) as QueryReturn[QUERY.REMOVE_TRANSCRIPTION];
  },
  ...
  UPDATE_TRANSCRIPTION: async (
    ...
    return (await ipcRenderer.invoke(
      ...
      args,
    )) as QueryReturn[QUERY.UPDATE_TRANSCRIPTION];
  },
  ...
  GET_LINE_COUNT: async (
    ...
    return (await ipcRenderer.invoke(
      ...
      args,
    )) as QueryReturn[QUERY.GET_LINE_COUNT];
  },
  GET_TRANSCRIPTION: async (
    ...
    return (await ipcRenderer.invoke(
      ...
      args,
    )) as QueryReturn[QUERY.GET_TRANSCRIPTION];
  },
  ...
  GET_ALL_LINES: async (args: QueryArgs[QUERY.GET_ALL_LINES]): QueryReturn[QUERY.GET_ALL_LINES] => {
    ...
    return (await ipcRenderer.invoke(
      QUERY.GET_ALL_LINES,
      args,
    )) as QueryReturn[QUERY.GET_ALL_LINES];
  },
  GET_LATEST_LINES: async (
  ...
  GET_ALL_ENTRIES_WITH_TRANSCRIPTIONS:
