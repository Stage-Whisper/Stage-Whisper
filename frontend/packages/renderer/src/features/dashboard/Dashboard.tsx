    ...
    <Center>
      <Stack style={{maxWidth: 1000}}>
        ...
        <Card withBorder>
          ...
          <Divider />
          <Text>
            This is where we will describe the application and how to use it. We will talk about the
            whisper model, give attribution, explain that this app works offline and that it is open
            source.
          </Text>
        </Card>
        <Card withBorder>
